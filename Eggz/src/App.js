...
function MainComponent() {
      ...
      try {
        ...
        if (err.constructor !== Object) {
          if (String(err).includes('"code":-32000')) {
            ...
            toast.error('Mint not Active yet');
          } else {
  ...
  return (
    <div className="App">
      ...
      <div className="kid">
        <img className="kid-img" src={egg} />
      </div>

      <div className="kid2">
        <img className="kid-img" src={egg2} />
      </div>
      ...
      <div className={`main-section ` + (walletConnected ? "connected" : " ")}>
        {
          !isStarted && (
            <div className="count-down"> 
              <Countdown className="mt-5" date={new Date("2022-12-16T18:00:00-0500")} renderer={renderer} />
        ...
        }
        {
          isStarted && walletConnected && (
            <>
              <div>
                <div className="totalMint"><img src={total} /></div>
